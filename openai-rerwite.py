...
# /Users/sauravtripathi/Downloads/generate-pdf/results/pdfs/Deep Learning With Pytorch.pdf

def process_json_and_update_with_checks(file_path, middle_file):
    """
    Process a JSON file, extract key points and detailed explanations using OpenAI client,
    and save updated content to a new JSON file.
    """
            ...
            for section in sections:
                ...
                if extracted_text:
                    try:
                        ...
                        print(f"Received key points for Section: {section_name}")
                        ...
                        print(f"Received detailed explanation for Section: {section_name}")
...
if __name__ == "__main__":
    input_json = input("Enter the path to the JSON file: ").strip()
