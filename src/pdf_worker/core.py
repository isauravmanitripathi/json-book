...
class PDFGenerator:
    ...
    # Updated _generate_single_pdf method in src/pdf_worker/core.py
    ...
    def _generate_single_pdf(self, output_path, book_title, author_name, style_config, chapters_data, part_num=None, total_parts=None):
        ...
        for chapter_idx, (original_chapter_id, sections) in enumerate(chapters_data, 1):
            ...
            for section_data in sections:
                ...
                if not section_text and not section_name:
                ...
                try:
                    ...
                    print(f"  - Error adding section '{section_name}': {str(e)}")
                        ...
                        if section_text:
                            story.append(Paragraph(section_text, 
                                                  ParagraphStyle(name='SimpleText', 
                                                                fontName='Helvetica', 
                                                                fontSize=10)))
                        print(f"  - Added simplified version of section '{section_name}'")
                    except Exception as e2:
                        print(f"  - Could not add section '{section_name}' even in simplified form: {str(e2)}")
        ...
        try:
            ...
            try:
                print("Attempting to build PDF with simplified content...")
                ...
                print("Successfully built simplified PDF")
            except Exception as e2:
                print(f"Failed to build even simplified PDF: {str(e2)}")
                raise
